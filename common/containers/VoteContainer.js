...
const mapStateToProps = (
  { normPollObj, fbggId, isFetching, fetchError },
  { _id },
) => {
  const choiceNameArr = normPollObj[_id].choiceArr.map(
    choiceObj => choiceObj.choiceName,
  );
...
const VoteContainer = connect(mapStateToProps, mapDispatchToProps)(
  VoteComponent,
);
