...
class NewPollComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = this.props.newPollInitState;
  ...
  handleSubmit(event) {
    ...
    const { newPollInitState, thunkNewPoll, history } = this.props;
  ...
  render() {
    ...
    const pollTitleTrimmed = this.state.pollTitle && 
      this.state.pollTitle.trim().replace(/\s+/g, ' ').toLowerCase();
    const itsAlreadyThere = pollTitleTrimmed && pollTitleArr.find(pollTitle => 
      pollTitle.toLowerCase() === pollTitleTrimmed
    );
    return (
      <div className="modal-dialog modal-lg" role="document">
        <div className="modal-content bg-light">
          <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Create A New Poll</h5>
          ...
          <div className="modal-body">
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; 
                <button type="button" className="btn btn-success btn-sm" onClick={this.handleClick}>
                  <i className="fa fa-plus" aria-hidden="true"></i> More Input Boxes
                </button>
...
NewPollComponent.propTypes = {
  newPollInitState: PropTypes.object,
  pollTitleArr: PropTypes.arrayOf(PropTypes.string).isRequired,
  thunkNewPoll: PropTypes.func,
